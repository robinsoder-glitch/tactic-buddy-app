...
describe("game-format", () => {
  ...
  it("mappar små spelformer till liten plan", () => {
    expect(pitchTypeForFormat("5v5")).toBe("small");
    expect(pitchTypeForFormat("7v7")).toBe("small");
    expect(pitchTypeForFormat("9v9")).toBe("full");
