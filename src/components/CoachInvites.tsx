  ...
  return (
    <main className="mx-auto max-w-2xl px-4 pb-28 pt-8 md:pt-20">
      ...
      <p className="mt-1 text-sm text-muted-foreground">
        Kallelser går aldrig ut automatiskt – du väljer när de skickas. De når spelarna och de vuxna
        som är kopplade till dem, och visas bara i appen. Träningar har ingen kallelse, där
